package com.github.andrew0030.pandora_core.modules.templater.loader.impl;
...
import com.github.andrew0030.pandora_core.modules.templater.wrapper.impl.VanillaTemplatedShader;
		...
		try {
			...
			if (firstFail) {
				...
				TemplateManager.postToast(
						PaCoIcon.VANILLA_20x20, ToastBackground.ERROR,
